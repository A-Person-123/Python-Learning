## Second mini project, any task will be written and save here.
...
if type_of_calc == 1:
    ...
    num1 = float(input("Type the the number you would like to find the power/root of: "))
    num2 = float(input("Type the number you would like to power/root the first number by: "))
    if operator == 1:
